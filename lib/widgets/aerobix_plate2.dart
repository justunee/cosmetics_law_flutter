...
class Aerobix2_question extends StatefulWidget {
  final customAnswer;
  const Aerobix2_question({Key? key, this.customAnswer}) : super(key: key);

  @override
  _Aerobix2_questionState createState() => _Aerobix2_questionState();
}

class _Aerobix2_questionState extends State<Aerobix2_question> {
  // Generate a list of available hobbies here
  List<Map> thaiBadge = [
    {
      "question": "Total aerobic plate count > 1000 cfu/ml หรือ cfu/mg",
      "firstBox": "ใช่",
      "secondBox": "ไม่ใช่",
    },
  ];
