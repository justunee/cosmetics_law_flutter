...
class Cosme_name_Question extends StatefulWidget {
  final customAnswer;
  const Cosme_name_Question({Key? key, this.customAnswer}) : super(key: key);

  @override
  _Cosme_name_QuestionState createState() => _Cosme_name_QuestionState();
}

class _Cosme_name_QuestionState extends State<Cosme_name_Question> {
  // Generate a list of available hobbies here
  List<Map> thaiBadge = [
    {
      "question": "ชื่อเครื่องสำอางบนฉลากตรงกับในใบรับจดแจ้งหรือไม่",
      "firstBox": "ตรง",
      "secondBox": "ไม่ตรง",
    },
  ];
