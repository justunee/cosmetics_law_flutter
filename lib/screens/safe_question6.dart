...
class Safe_question6Page extends ConsumerStatefulWidget {
  const Safe_question6Page({Key? key, required this.title}) : super(key: key);
  ...
  @override
  ConsumerState<Safe_question6Page> createState() => _Safe_question6PageState();
}

class _Safe_question6PageState extends ConsumerState<Safe_question6Page> {
  List<Map> Answer = [
    {
      "firstBox": false,
      "secondBox": false,
        ...
        child: Container(
          ...
          child: Center(
            ...
            child: Column(
              ...
              children: <Widget>[
                Aerobix2_question(customAnswer: parentSetAnswer)
              ],
            ),
          ),
        ),
