...
import 'package:cosmetics_law/widgets/chemistry_true_false.dart';
import 'package:flutter/material.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';

class Safe_question1Page extends ConsumerStatefulWidget {
  const Safe_question1Page({Key? key, required this.title}) : super(key: key);
  ...
  @override
  ConsumerState<Safe_question1Page> createState() => _Safe_question1PageState();
}

class _Safe_question1PageState extends ConsumerState<Safe_question1Page> {
  List<Map> Answer = [
    {
      "firstBox": false,
      "secondBox": false,
        ...
        child: Container(
          ...
          child: Center(
            ...
            child: Column(
              ...
              children: <Widget>[
                Chemistry_True_False_Question(customAnswer: parentSetAnswer)
              ],
            ),
          ),
        ),
