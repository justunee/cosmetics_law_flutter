...
class Safe_question3Page extends ConsumerStatefulWidget {
  const Safe_question3Page({Key? key, required this.title}) : super(key: key);
  ...
  @override
  ConsumerState<Safe_question3Page> createState() => _Safe_question3PageState();
}

class _Safe_question3PageState extends ConsumerState<Safe_question3Page> {
  List<Map> Answer = [
    {
      "firstBox": false,
      "secondBox": false,
        ...
        child: Container(
          ...
          child: Center(
            ...
            child: Column(
              ...
              children: <Widget>[
                Found_Bio_question(customAnswer: parentSetAnswer)
              ],
            ),
          ),
        ),
