...
import 'package:cosmetics_law/widgets/aerobix_plate.dart';
import 'package:cosmetics_law/widgets/bottom_bar.dart';
import 'package:flutter/material.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';

class Safe_question5Page extends ConsumerStatefulWidget {
  const Safe_question5Page({Key? key, required this.title}) : super(key: key);
  ...
  @override
  ConsumerState<Safe_question5Page> createState() => _Safe_question5PageState();
}

class _Safe_question5PageState extends ConsumerState<Safe_question5Page> {
  List<Map> Answer = [
    {
      "firstBox": false,
      "secondBox": false,
        ...
        child: Container(
          ...
          child: Center(
            ...
            child: Column(
              ...
              children: <Widget>[
                Aerobix_question(customAnswer: parentSetAnswer)
              ],
            ),
          ),
        ),
