...
class Question9Page extends ConsumerStatefulWidget {
  const Question9Page({Key? key, required this.title}) : super(key: key);
  ...
  @override
  ConsumerState<Question9Page> createState() => _Question9PageState();
}

class _Question9PageState extends ConsumerState<Question9Page> {
  List<Map> Answer = [
    {
      "firstBox": false,
      "secondBox": false,
        ...
        onClickAction: () {
          if (Answer[0]["firstBox"] == true) {
            ...
            ref
                ...
                .answer(false, AnswerKey.paperInfo);
