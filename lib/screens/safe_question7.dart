...
import 'package:cosmetics_law/widgets/aerobix_plate2.dart';
import 'package:cosmetics_law/widgets/bottom_bar.dart';
import 'package:cosmetics_law/widgets/virus_cosme.dart';
import 'package:flutter/material.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';

class Safe_question7Page extends ConsumerStatefulWidget {
  const Safe_question7Page({Key? key, required this.title}) : super(key: key);
  ...
  @override
  ConsumerState<Safe_question7Page> createState() => _Safe_question7PageState();
}

class _Safe_question7PageState extends ConsumerState<Safe_question7Page> {
  List<Map> Answer = [
    {
      "firstBox": false,
      "secondBox": false,
        ...
        child: Container(
          ...
          child: Center(
            ...
            child: Column(
              ...
              children: <Widget>[
                Virus_Cosme_Question(customAnswer: parentSetAnswer)
              ],
            ),
          ),
        ),
